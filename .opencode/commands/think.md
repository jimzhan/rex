---
name: think
description: Explore user intent, covert it into a detailed execution plan for implementation.
disable-model-invocation: true
---
Execute the following 3 steps in **strict order**. Do **not** proceed to the next step until the current step's **completion criteria** are fully met.
...
- Create a dedicated Git worktree to isolate the planning session (e.g., naming convention: `<YY-MM-DD>-<feature-name>`).
...
- **Prerequisite Check:** Before initiating this step, **MUST** verify that:
  - Step 1 has received user approval.
  - Step 2 has successfully created the new Git worktree.
